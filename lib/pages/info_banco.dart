                  ...
                  itemBuilder: (context, index) {
                    return Dismissible(
                      ...
                      confirmDismiss: (direction) async {
                        ...
                        result = await showDialog(
                            ...
                            builder: (context) {
                              return AlertDialog(
                                title: Text(
                                    "Esta seguro de archivar la cuenta ${snapshot.data?[index]['bid']}?"),
                                actions: [
                                  TextButton(
                                      onPressed: () {
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          await Navigator.pushNamed(context, "/editBanco",
                              arguments: {
                                ...
                                "tipoCuenta": snapshot.data?[index]
                                    ['tipoCuenta'],
                              });
                          setState(() {});
                        }),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const AddBancoPage()));
          setState(() {});
        },
