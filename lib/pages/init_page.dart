            ...
            children: <Widget>[
                            ...
                            if (quotePressed == true &&
                              ...
                              setState(() {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          AddQuotePage(loteInfo: currentLote)),
                                );
                              });
                            } else {
                              setState(() {});
              ...
              Expanded(
                ...
                child: Container(
                  ...
                  child: Center(
                    child:
                        easyDropdown(etapasList, selectedItemEtapa, (tempItem) {
                      setState(
                        () {
                          ...
                          if (selectedItemEtapa == "Etapa Premium") {
                            ...
                            if (selectedItemEtapa == "Etapa 1") {
                              imgEtapa = "E01.png";
                              etapaColor = fourthColor.withOpacity(0.8);
                            } else {
                              if (selectedItemEtapa == "Etapa 2") {
                                imgEtapa = "E02.png";
                                etapaColor = fourthColor.withOpacity(0.8);
                              } else {
                                imgEtapa = "E00.png";
