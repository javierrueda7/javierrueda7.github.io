...
class _EditLotePageState extends State<EditLotePage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (isInitialized == false) {
      ...
      areaController.text =
          '${((arguments['loteArea'].toInt()).toString())} m²';
      priceController.text =
          (currencyCOP((arguments['lotePrice'].toInt()).toString()));
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text(
            'Editar ${loteNameController.text}',
            style: TextStyle(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: textFieldWidget("Id", Icons.abc_outlined, false,
                            idController, false, 'email', () {}),
                      ),
                      const SizedBox(
                        height: 20,
                      ),
                      Container(
                        constraints: const BoxConstraints(maxWidth: 800),
                        child: textFieldWidget("Lote", Icons.gps_fixed_outlined,
                            false, loteNameController, false, 'email', () {}),
                      ),
                      const SizedBox(
                        height: 20,
                      ),
                      Container(
                        constraints: const BoxConstraints(maxWidth: 800),
                        child: textFieldWidget("Etapa", Icons.map_outlined,
                            false, etapaController, false, 'email', () {}),
                      ),
                      const SizedBox(
                        height: 20,
                      ),
                      ...
                      Container(
                        constraints: const BoxConstraints(maxWidth: 800),
                        child: textFieldWidget("Estado", Icons.sell_outlined,
                            false, stateController, false, 'email', () {}),
                      ),
                      const SizedBox(
                        height: 20,
                      ),
