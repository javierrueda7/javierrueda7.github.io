  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          'Cotizaciones archivadas${loteVerifier(needAll)}',
          style: TextStyle(
                    ...
                    return FutureBuilder(
                        ...
                        builder: ((context, custSnapshot) {
                          if (custSnapshot.hasData) {
                            final custData = custSnapshot.data?.data()
                                    ...
                                    return Dismissible(
                                      ...
                                      confirmDismiss: (direction) async {
                                        ...
                                        result = await showDialog(
                                            ...
                                            builder: (context) {
                                              return AlertDialog(
                                                title: Text(
                                                    "Esta seguro de activar la cotizacion #${snapshot.data?[index]['qid']}?"),
                                                actions: [
                                                  TextButton(
                                                      onPressed: () {
                                      ...
                                      child: ListTile(
                                        leading: CircleAvatar(
                                            backgroundColor: stageColor(snapshot
                                                .data?[index]['quoteStage']),
                                            child: Text(
                                              getNumbers(snapshot.data?[index]
                                                  ['loteName'])!,
                                        ...
                                        trailing: PopupMenuButton<String>(
                                          itemBuilder: (context) => [
                                            ...
                                            PopupMenuItem(
                                              ...
                                              value: 'Opción 2',
                                              child: Text(changeState(snapshot
                                                  .data?[index]['quoteStage'])),
                                            ),
                                            PopupMenuItem(
