...
class _AddSellerPageState extends State<AddSellerPage> {
  ...
  final TextEditingController startDateController = TextEditingController(text: DateFormat('dd-MM-yyyy').format(DateTime.now()));
                ...
                child: Column(
                  children: <Widget>[
                      ...
                      child: Padding(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: DateFormat('dd-MM-yyyy').format(startDate),                                    
                          ),
                          readOnly: true,
                          onTap: () async{
                    ...
                    Container(
                      constraints: const BoxConstraints(maxWidth: 800),
                      child: textFieldWidget(
                        "Nombres", Icons.person_outline, false, _nameTextController, true, 'name', (){}
                      ),
                    ),
                    const SizedBox(
                      height: 20,
                    ...
                    Container(
                      constraints: const BoxConstraints(maxWidth: 800),
                      child: textFieldWidget(
                        "Teléfono", Icons.phone_android_outlined, false, _phoneTextController, true, 'phone', (){}
                      ),
                    ),
                    const SizedBox(
                      height: 20,
                    ...
                    Container(
                      constraints: const BoxConstraints(maxWidth: 800),
                      child: textFieldWidget(
                        "Correo electrónico", Icons.email_outlined, false, _emailTextController, true, 'email', (){}
                      ),
                    ),
                    const SizedBox(
                      height: 20,
